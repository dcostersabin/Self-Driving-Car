...
# ++++++++++++++++++++++++++++++++++++++++++++++ TUNABLE VARIABLES +++++++++++++++++++++++++++++++
NO_OF_NEURONS_IN_HIDDEN_LAYER = 30
...
class Network(nn.Module):
    ...
    def __init__(self, input_size, nb_action):
        ...
        self.fc1 = nn.Linear(input_size, NO_OF_NEURONS_IN_HIDDEN_LAYER)
        self.fc2 = nn.Linear(NO_OF_NEURONS_IN_HIDDEN_LAYER, nb_action)
...
class Dqn():
    ...
    def select_action(self, state):
        prob = F.softmax(self.model(Variable(state, volatile=True)) * 1000)
